...
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  new Notification(2, 'Subject 3', 'Body 3', NotificationLevel.INFO),
  new Notification(2, 'Subject 4', 'Body 4', NotificationLevel.WARNING),
  new Notification(2, 'Subject 5', 'Body 5', NotificationLevel.DANGER)
];
